...
def mail(gmail_user, gmail_pwd, to, subject, text, attach):
   ...
   msg.add_header('Cc', 'Ashley.Gau@blackbaud.com;Mari.Batilando@blackbaud.com;Oscar.Bachtiar@blackbaud.com;Christine.Loh@blackbaud.com,Vinit.Nayak@blackbaud.com,bkbdtimesheet@gmail.com')
   msg.add_header('To', 'Vinit.Nayak@blackbaud.com;Oscar.Bachtiar@gmail.com')
